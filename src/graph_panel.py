...
sessions, notebook, zones, measurements, and the selected scenario's narrative
events). "Refresh" re-gathers them. Reuses graph_model, events, and the M1 bus.
"""
...
class GraphPanel(QtWidgets.QWidget):
    ...
    def _gather(self):
        ...
        return entries, zones, measures, experiments, sessions, ev

    def _rebuild(self) -> None:
        entries, zones, measures, experiments, sessions, ev = self._gather()
